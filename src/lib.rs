...
#[derive(Debug)]
pub struct SwapShardProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SwapShardProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SwapShard processing");
    
    let mut processor = SwapShardProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SwapShardProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SwapShardProcessor::new(false);
